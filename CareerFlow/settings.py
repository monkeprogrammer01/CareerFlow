...
SECRET_KEY = 'django-insecure-7o5x@-r2+irxx!07lgw^u2k68)xyx%3@46lh(#3ljk98f0q(5@'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'CareerFlow',  # Replace with your database name
...
SIMPLE_JWT = {
    ...
    'AUTH_HEADER_TYPES': ('Bearer',),              # Префикс для токенов
}
